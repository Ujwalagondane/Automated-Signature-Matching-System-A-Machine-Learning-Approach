...
def captureImage(ent, sign=1):
    if sign == 1:
        # Set the filename for the first signature image from the dataset
        # Replace "path_to_image1.png" with the actual path of img1 from your dataset
        filename = "C:/Users/sumed/OneDrive/Desktop/Signature-Matching/assets"
    else:
